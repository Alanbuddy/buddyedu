...
Route::get('/merchants/{merchant}/course-applications', 'MerchantController@courseApplications')->name('merchant.courses.application');
Route::get('/merchants/{merchant}/schedules', 'MerchantController@schedules')->name('merchant.schedules');//开课授权
Route::get('/merchants/{merchant}/schedule-applications', 'MerchantController@scheduleApplications')->name('merchant.schedule.application');//课程授权
