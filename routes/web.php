...
//        Route::get('/schedules/search', 'ScheduleController@search')->name('schedule.search');
        ...
        Route::post('/merchants/{merchant}/courses/{course}/quantity', 'MerchantController@updateQuantity')->name('merchant.course.quantity.update');//课程授权
...
Route::get('/notices/list', 'Notice\NoticeController@index')->name('notice.list');
...
Route::get('/sms/send-code', 'SmsController@send')->name('sms.send')->middleware('api');
